...
![](images/clipboard-3200176383.png)

This is not tidy data, but that's okay. I renamed the columns:

-   Census Tract to census_tract_number

-   N to `n_number`

-   Pb (ppm) to `pb_ppm_average` note that it is mg/kg

I renamed the columns already for easier data processing. I did this in Excel because it is simply easier to do this in a WYSIWYG editor, even though it is fairly easy to change column names in R.
