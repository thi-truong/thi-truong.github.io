...
This is pretty tidy data that I do not need to transform into proper variables/values/etc. However, I added a column to make a primary key (number for each observation) and I renamed some columns to be more descriptive. I did this in Excel because it is simply easier to do this in a WYSIWYG editor, even though it is fairly easy to change column names in R!
